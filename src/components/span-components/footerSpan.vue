<template>
    <footer v-motion-slide-bottom class="duration-1000 p-4 bg-white dark:bg-gray-800">
        ...
        <div class="sm:flex sm:items-center sm:justify-between sm:px-4">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© {{this.currentYear}} Made with <a href="#" class="hover:underline">love</a> by Sefa Burak.
            </span>
