<template>
  <main class="relative flex justify-around items-center flex-wrap px-6 lg:px-8">
    <div class="mx-8 sm:mx-12 max-w-3xl pt-20 pb-32 sm:pt-36 sm:pb-40">
      ...
      >
        <h6
          ...
          class="duration-1000 dark:text-gray-400 text-sm italic tracking-tight sm:text-start sm:text-sm mb-3"
        >
          ~ {{ $store.state.user.currentLang["home_text_hello"] }}
        </h6>
        <h1
          class="duration-1000 dark:text-white/90 text-4xl font-bold tracking-tight sm:text-start italic sm:text-6xl"
        >
          Sefa Burak Dereli
        </h1>
        <p
    ...
    >
      <div
        class="flex flex-col justify-center sm:text-base text-[15px] w-80 duration-1000 md:w-96 h-80 border-2 rounded-2xl dark:border-gray-700/20 dark:bg-gray-800/75 bg-gray-200/50 shadow-2xl shadow-blue-600/10 py-16 px-4"
      >
        <div class="font-mono">
          <span class="text-gray-500 mr-0 md:mr-4">1</span>&nbsp;&nbsp;<span
            class="text-purple-800 dark:text-purple-600"
            >export default</span
          ><span class="text-orange-400">{</span>
        </div>
        <div class="font-mono">
          <span class="text-gray-500 mr-0 md:mr-5">2</span>&nbsp;&nbsp;&nbsp;&nbsp;<span
            class="text-blue-600"
            >data</span
          ><span class="text-purple-800 dark:text-purple-600 tracking-widest"> () {</span>
        </div>
        <div class="font-mono">
          <span class="text-gray-500 mr-0 md:mr-6">3</span
          >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="text-red-500">name</span
          ><span class="text-blue-600">:</span>
          <span class="text-green-800 dark:text-green-500">'Sefa Burak'</span
          ><span class="dark:text-white"> ,</span>
        </div>
        <div class="font-mono">
          <span class="text-gray-500 mr-0 md:mr-6">4</span
          >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="text-red-500">age</span
          ><span class="text-blue-600">:</span>
          <span class="text-purple-800 dark:text-purple-600">new</span>
          <span class="text-yellow-500">(</span><span class="text-blue-600">Date</span
          ><span class="text-purple-800 dark:text-purple-600 tracking-widest">()</span
          ><span class="dark:text-white">.</span
          ><span class="text-blue-600">getFullYear</span
          ><span class="text-purple-800 dark:text-purple-600 tracking-widest">()</span>
        </div>
        <div class="font-mono">
          <span class="text-gray-500 mr-0 md:mr-6">5</span
          >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span
            class="text-purple-800 dark:text-purple-600"
            >-</span
          >
          <span class="text-orange-600">2005</span><span class="text-yellow-500">)</span
          ><span class="dark:text-white">,</span>
        </div>
        <div class="font-mono">
          <span class="text-gray-500 mr-0 md:mr-5">6</span>&nbsp;&nbsp;&nbsp;&nbsp;<span
            class="text-purple-800 dark:text-purple-600"
            >}</span
          ><span class="dark:text-white"> ,</span>
        </div>
        <div class="font-mono">
          <span class="text-gray-500 mr-0 md:mr-4">7</span>&nbsp;&nbsp;<span
